    ...
    return (
        <div className="flex flex-col w-full max-md:hidden">
            <div className="flex flex-col w-full text-black max-md:max-w-full">
                ...
                <div className="flex flex-wrap gap-10 justify-center items-center p-6 mt-1 w-full text-2xl leading-9 bg-background rounded-xl max-md:px-5 max-md:max-w-full">
                    ...
                    <div className="flex-1 shrink self-stretch my-auto leading-loose basis-0">
