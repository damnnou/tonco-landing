    ...
    return (
        <div className="flex flex-col w-full md:hidden">
            <div className="flex overflow-hidden flex-col px-2 py-3 w-full bg-background rounded-xl">
                <div className="text-xl text-primary">Capital Efficiency</div>
                <div className="flex flex-col mt-2 w-full">
                    <div className="flex gap-6 items-center p-2 w-full bg-white rounded">
            ...
            <div className="flex overflow-hidden flex-col px-2 py-3 mt-2 w-full bg-background rounded-xl">
                <div className="text-xl text-primary">Fees Mechanism</div>
                <div className="flex flex-col mt-2 w-full">
                    <div className="flex gap-6 items-center py-2 pr-1.5 pl-2 w-full bg-white rounded">
            ...
            <div className="flex overflow-hidden flex-col px-2 py-3 mt-2 w-full bg-background rounded-xl">
                <div className="text-xl text-primary">Liquidity</div>
                <div className="flex flex-col mt-2 w-full">
                    <div className="flex gap-6 items-center p-2 w-full bg-white rounded">
                        <div className="flex items-center justify-center w-24 gap-2.5 self-stretch px-2 py-1.5 my-auto text-sm text-white bg-primary rounded-[60px]">
                            TONCO
            ...
            <div className="flex overflow-hidden flex-col px-2 py-3 mt-2 w-full bg-background rounded-xl">
                <div className="text-xl text-primary">Impermanent Loss</div>
                <div className="flex flex-col mt-2 w-full">
                    <div className="flex gap-6 items-center py-2 pr-1.5 pl-2 w-full bg-white rounded">
                        <div className="flex items-center justify-center w-24 gap-2.5 self-stretch px-2 py-1.5 my-auto text-sm text-white bg-primary rounded-[60px]">
                            TONCO
