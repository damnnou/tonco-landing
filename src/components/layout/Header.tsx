    ...
    return (
        ...
        >
            <div className="flex py-4 px-7 max-md:px-4 max-w-[1440px] w-full justify-between items-center mx-auto">
                <TONCOLogo className={menuOpen ? '!fill-primary-green' : ''} />
                <button
                ...
                >
                    {menuOpen ? (
                        <X className="!text-primary-green" />
                    ) : (
                        <MenuLogo
                            className={menuOpen ? '!fill-primary-green' : ''}
                        />
                    )}
                </button>
                <nav className="flex gap-5 items-center max-md:hidden">
                    ...
                    <Button
                        id="menu-button"
                        onClick={() =>
                            window.open('https://t.me/tonco_io', '_blank')
                        }
                        variant="secondary"
                    >
                        <TgLogo />
                    ...
                    <Button
                        id="menu-button"
                        onClick={() =>
                            window.open('https://x.com/Tonco_io', '_blank')
                        }
                        variant="secondary"
                    >
                        <XLogo />
            ...
            <nav className="flex flex-col p-5 pt-0 w-full gap-5 mx-auto text-black md:hidden">
                ...
                <Button
                    ...
                    // className={
                    //     menuOpen
                    //         ? '!bg-primary-green !text-white hover:!translate-y-0'
                    //         : ''
                    // }
                    id="launch-button"
                    variant="primary"
